                    ...
                    <Link to={`/donationdetails/${id}`}>
                        <div className={`card card-compact rounded-sm w-80 bg-green-200`}>
                            ...
                            <div className="card-body">
                                <p className="w-min p-1 rounded-md font-bold bg-green-300">{category}</p>
                ...
                {category === "Health" && 
                    ...
                    <Link to={`/donationdetails/${id}`}>
                        <div className={`card card-compact rounded-sm w-80 bg-blue-200`}>
                            <figure><img src={image} className="w-full" /></figure>
                            <div className="card-body">
                                <p className="w-min p-1 rounded-md font-bold bg-blue-300">{category}</p>
                ...
                {category === "Education" && 
                    ...
                    <Link to={`/donationdetails/${id}`}>
                        <div className={`card card-compact rounded-sm w-80 bg-red-200`}>
                            <figure><img src={image} className="w-full" /></figure>
                            <div className="card-body">
                                <p className="w-min p-1 rounded-md font-bold bg-red-300">{category}</p>
                ...
                {category === "Food" && 
                    ...
                    <Link to={`/donationdetails/${id}`}>
                        <div className={`card card-compact rounded-sm w-80 bg-orange-200`}>
                            <figure><img src={image} className="w-full" /></figure>
                            <div className="card-body">
                                <p className="w-min p-1 rounded-md font-bold bg-orange-300">{category}</p>
