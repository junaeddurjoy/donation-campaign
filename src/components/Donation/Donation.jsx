...
const Donation = () => {
    ...
    return (
        <div>
            <div className="grid grid-cols-2 mx-20 mb-10 gap-12">
                {
                    appliedDonations.slice(0,dataLength).map(donate =>
                        <div key={donate.id}>
            ...
            <div className={dataLength === donates.length && 'hidden'}>
                <div className="text-center my-10">
                    <button onClick={() => setdataLength(donates.length)} className="bg-purple-300 w-40 p-4 text-xl font-semibold rounded-xl">Show All</button>
                </div>
            </div>
        </div>
    );
